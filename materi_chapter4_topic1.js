...
class person {
  static makan = "malik makan nasi"
  constructor({name, address}) {
    this.name = name
    this.address = address
  }
  berjalan(){
    console.log(`${this.name} Berjalan ke ${this.address}`)
  }
  berlari(){
    console.log(`${this.name} Berlari dari  ${this.address} menuju jawa`)
  }
}
